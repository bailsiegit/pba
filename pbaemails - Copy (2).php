...
<form action="pbaemails.php" method="POST">
    ...
    <!-- Download button -->
    <div id="dlbutton" style="visibility:visible; flex:50%;">
    ...
    <!-- Dynamic group members container -->
	<div style="display:flex; justify-content:flex-start; gap:20px;">
    <div id="egroupselect-wrapper" style="flex:40%;">
    ...
    <!-- Action buttons -->
    <div id="actions" style="margin-top:20px; flex:20%;">
        <input type="submit" style="margin:30px;" name="delfromemails" value="Remove">
        <input type="submit" style="margin:30px;" name="addtoemails" value="Add">
    </div>
    <!-- Non-members container -->
    <div id="nonmembers-wrapper" style="flex:40%;">
